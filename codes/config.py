...
tf.app.flags.DEFINE_multi_string ('train_scenes', ["bathroom", "bathroom2", "box", "classroom", "glass", "living-room", "living-room-2", "spaceship", "sponza", "staircase", "torus", "veach-lamp"],
